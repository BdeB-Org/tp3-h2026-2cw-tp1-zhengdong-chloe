 ...
 *
 * Toutes les requêtes fetch() passent par ce fichier.
 * Mode MOCK : simule Oracle ORDS avec localStorage.
 * Mode ORDS : décommenter BASE_URL et mettre MOCK_MODE = false.
 */
...
const API_CONFIG = {
  ...
  // true = données simulées localement (localStorage)
  // false = appels réels vers Oracle ORDS
  MOCK_MODE: true,
};

/* ══════════════════════════════════════════════
   DONNÉES INITIALES (mode mock uniquement)
   ══════════════════════════════════════════════ */
const INITIAL_DATA = {
  fabricants: [
...
/* ══════════════════════════════════════════════
   INITIALISATION DU MOCK (localStorage)
   ══════════════════════════════════════════════ */
